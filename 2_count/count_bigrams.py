from fun import count_bigrams
import pandas as pd

hyperpartisan = count_bigrams("./articles/hyperpartasian.txt")
...
non_hyperpartisan = count_bigrams("./articles/non-hyperpartasian.txt")
...
freqs.to_csv("bigram_frequencies.csv")