...
fname1 = "./ground-truth-validation-bypublisher-20181122.xml"
...
fname2 = "./articles-validation-bypublisher-20181122.xml"
tree = etree.parse(fname2, parser)

if not os.path.exists("articles"):
    os.mkdir("articles")

open("articles/hyperpartasian.txt", 'w').close()
open("articles/non-hyperpartasian.txt", 'w').close()
